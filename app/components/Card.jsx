...
export default function Card() {
  return (
    <div className="pb-12 pt-5" id="project">
        {/* lil card */}
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="absolute w-[80%] ">
            ...
            <div className="pt-3 flex gap-3">
              ...
              >
                <span className="text-xl py-3 underline underline-offset-4 duration-200 hover:text-blue-700 font-semibold">Web Cafe</span>
              </a>
              ...
              <a
                ...
                className={alegreya.className}
              >
                <span className="text-xl py-3 underline underline-offset-4 duration-200 hover:text-blue-700 font-semibold">Github</span>
              </a>
            </div>
          </div>
        </div>
          ...
          <div className="absolute w-[80%] ">
            ...
            <div className="pt-3 flex gap-3">
              <a
                ...
                className={alegreya.className}
              >
                <span className="text-xl py-3 underline underline-offset-4 duration-200 hover:text-blue-700 font-semibold">FloodPost</span>
              </a>
              <p className="font-bold text-gray-400">|</p>
              <a
      ...
      <div className="hidden md:flex flex-col gap-10">
        ...
        <div className="flex flex-col justify-center items-center">
          <div className="bg-white w-[85%] flex rounded-md items-center h-[35rem] shadow-md"></div>
          <div className="absolute w-[80%] ">
            <Image src={cafe} alt="web-cafe" className="" />
            <div className="pt-3 flex gap-3">
              <a
                href="https://web-cafe-two.vercel.app/"
                className={alegreya.className}
